...
@SourceType(value = "PipedriveARP", label = "Pipedrive",uiConfig = "pipedrive-layout.json")
public class PipedriveConf extends AbstractArpConf<PipedriveConf> {
  private static final String ARP_FILENAME = "arp/implementation/pipedrive-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.pipedrive.PipedriveDriver";
